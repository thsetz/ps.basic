...
# LOCK FILE THINGS
#
def test_properties_are_set_using_guarded_by_lockfile_the_lock_file_does_NOT_already_exist(
    dev_allowed_stages,
):
    ...
    lock_filename = os.path.join(
        os.getcwd(),
        "%s_lock%s" % (TEST_SERVICE_NAME, DEV_STAGES[dev_allowed_stages]["suffix"]),
    )   
